...
def LFT_Spill():
    spill_2Khood = np.array([[0.081, 0.081, 0.081],[0.084, 0.084, 0.084],[0.089, 0.062, 0.027],[0.077, 0.047, 0.011]]) #spillover at 2K hood
    spill_2Kstop = np.array([[0., 0., 0.],[0., 0., 0.],[0.183, 0.122, 0.048],[0.156, 0.088, 0.020]]) #spillover at 2K stop
    spill_20K    = np.array([[0.004, 0.002, 0.001],[0.003, 0.002, 0.001],[0.004, 0.004, 0.004],[0.004, 0.004, 0.004]]) #spillover at 20K HWP mount
    spill_5Kenve = np.array([[0.286, 0.137, 0.128],[0.195, 0.186, 0.185],[0.193, 0.087, 0.026],[0.134, 0.055, 0.011]]) #spillover at 5K envelope
