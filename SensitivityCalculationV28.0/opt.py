...
def Temp_Opt():
    ...
    Tr_len = 5. # reflected temp of detector lenslet
...
def LFT_Hwp(): #LFT HWP with ARC 
    ...
    pol_hwp_LFT = np.array([[0.87, 0.965, 0.960],[0.929, 0.961, 0.970],[0.961, 0.970, 0.982],[0.960, 0.980, 0.964]]) #polarization eff
