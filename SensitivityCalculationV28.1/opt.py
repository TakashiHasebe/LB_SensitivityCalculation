...
def Temp_Opt():
    ...
    Tr_horn = 2. # reflected temp of HFT-lens
    Tr_det = 0.17
    return  T_bath, T_cmb, T_hwp_LFT,T_hwp_HFT,T_apt, T_mir, T_fil, T_len, T_lens, T_baf, Tr_hwp,Tr_mir,Tr_fil,Tr_len,Tr_lens,Tr_horn,Tr_det
...
def HFT_Det():# detector coupling efficiency
    ...
    det_eff_HFT = np.array([[0.76,0.76,0.76,0.76,0.76],[0.75, 0.75, 0.75,0.75,0.75]])
    return det_eff_HFT 
