...
##########################################################################
    ...
    for j in range(0,n3):
        ...
        for k in range(0,num):
            ...
            fil_emiss_MFT, fil_eff_MFT = f.Trm(t_fil_MFT, n_fil_MFT, tan_fil_MFT, freq*1.e9, ref_fil_MFT)

            p_cmb = f.BB(freq*1.e9,T_cmb)*hwp_eff*apt_eff*L1_eff*L2_eff*fil_eff_MFT*det_eff_MFT[j] # 

########################## HWP  ##############
            ############# Trans  #############
            p_hwp_trans = f.BB(freq*1.e9,T_hwp_MFT)*HWP_spill_MFT[j]*hwp_emiss_MFT[j]*apt_eff*L1_eff*L2_eff*fil_eff_MFT*det_eff_MFT[j]
           
            ########### 1st order  ###########
            p_hwp_ref1 = (f.BB(freq*1.e9,T_abs_MFT)*abs1_HWP_spill_MFT[j]*apt_eff+
                f.BB(freq*1.e9,T_abs_MFT)*abs2_HWP_spill_MFT[j]*L1_eff*apt_eff+
                f.BB(freq*1.e9,T_hood_MFT)*Hood_HWP_spill_MFT[j]*L2_eff*L1_eff*apt_eff
                )*ref_hwp_MFT[j]*apt_eff*L1_eff*L2_eff*fil_eff_MFT*det_eff_MFT[j]
           
            ########### 2nd order  ###########
            p_hwp_ref2 = (
                f.BB(freq*1.e9,T_L1_MFT)*L1_HWP_spill_MFT[j]*emiss_L1_MFT[j]+
                f.BB(freq*1.e9,T_L2_MFT)*L2_HWP_spill_MFT[j]*emiss_L2_MFT[j]*L1_eff+
                f.BB(freq*1.e9,T_fil_MFT)*fil_HWP_spill_MFT[j]*fil_emiss_MFT*L2_eff*L1_eff+
                (f.BB(freq*1.e9,T_abs_MFT)*abs1_L1_HWP_spill_MFT[j]+
                    f.BB(freq*1.e9,T_apt_MFT)*apt_L1_HWP_spill_MFT[j]+
                    f.BB(freq*1.e9,T_cmb)*CMB_L1_HWP_spill_MFT[j]*hwp_eff*apt_eff
                    )*ref_L1_MFT[j]+
                (f.BB(freq*1.e9,T_abs_MFT)*abs2_L2_HWP_spill_MFT[j]+
                    f.BB(freq*1.e9,T_abs_MFT)*abs1_L2_HWP_spill_MFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_apt_MFT)*apt_L2_HWP_spill_MFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_L2_HWP_spill_MFT[j]*hwp_eff*apt_eff*L1_eff
                    )*ref_L2_MFT[j]*L1_eff+
                (f.BB(freq*1.e9,T_hood_MFT)*Hood_fil_HWP_spill_MFT[j]+
                    f.BB(freq*1.e9,T_abs_MFT)*abs2_fil_HWP_spill_MFT[j]*L2_eff+
                    f.BB(freq*1.e9,T_abs_MFT)*abs1_fil_HWP_spill_MFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_apt_MFT)*apt_fil_HWP_spill_MFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_fil_HWP_spill_MFT[j]*hwp_eff*apt_eff*L1_eff*L2_eff
                    )*ref_fil_MFT*L2_eff*L1_eff
                )*ref_hwp_MFT[j]*apt_eff*L1_eff*L2_eff*fil_eff_MFT*det_eff_MFT[j]
...
########################## APT  ##############
            ############# Trans  #############
            p_apt = f.BB(freq*1.e9,T_apt_MFT)*apt_spill_MFT[j]*L1_eff*L2_eff*fil_eff_MFT*det_eff_MFT[j]

########################## L1   ##############
            ############# Trans  #############
            p_L1_trans = f.BB(freq*1.e9,T_L1_MFT)*L1_spill_MFT[j]*emiss_L1_MFT[j]*L2_eff*fil_eff_MFT*det_eff_MFT[j]
           
            ########### 1st order  ###########
            p_L1_ref1 = (f.BB(freq*1.e9,T_abs_MFT)*abs2_L1_spill_MFT[j]+
                f.BB(freq*1.e9,T_hood_MFT)*Hood_L1_spill_MFT[j]*L2_eff
                )*ref_L1_MFT[j]*L2_eff*fil_eff_MFT*det_eff_MFT[j]
           
            ########### 2cd order  ###########
            p_L1_ref2 = (
                f.BB(freq*1.e9,T_L2_MFT)*L2_L1_spill_MFT[j]*emiss_L2_MFT[j]+
                f.BB(freq*1.e9,T_fil_MFT)*fil_L1_spill_MFT[j]*fil_emiss_MFT*L2_eff+
                (f.BB(freq*1.e9,T_abs_MFT)*abs2_L2_L1_spill_MFT[j]+
                    f.BB(freq*1.e9,T_abs_MFT)*abs1_L2_L1_spill_MFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_apt_MFT)*apt_L2_L1_spill_MFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_L2_L1_spill_MFT[j]*hwp_eff*apt_eff*L1_eff
                    )*ref_L2_MFT[j]+
                (f.BB(freq*1.e9,T_hood_MFT)*Hood_fil_L1_spill_MFT[j]+
                    f.BB(freq*1.e9,T_abs_MFT)*abs2_fil_L1_spill_MFT[j]*L2_eff+
                    f.BB(freq*1.e9,T_abs_MFT)*abs1_fil_L1_spill_MFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_apt_MFT)*apt_fil_L1_spill_MFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_fil_L1_spill_MFT[j]*hwp_eff*apt_eff*L1_eff*L2_eff
                    )*ref_fil_MFT*L2_eff
                )*ref_L1_MFT[j]*L2_eff*fil_eff_MFT*det_eff_MFT[j]
...
########################## L2   ##############
            ############# Trans  #############
            p_L2_trans = f.BB(freq*1.e9,T_L2_MFT)*L2_spill_MFT[j]*emiss_L2_MFT[j]*fil_eff_MFT*det_eff_MFT[j]
           
            ########### 1st order  ###########
            p_L2_ref1 = (f.BB(freq*1.e9,T_hood_MFT)*Hood_L2_spill_MFT[j])*ref_L2_MFT[j]*fil_eff_MFT*det_eff_MFT[j]
           
            ########### 2cd order  ###########
            p_L2_ref2 = (
                f.BB(freq*1.e9,T_fil_MFT)*fil_L2_spill_MFT[j]*fil_emiss_MFT+
                (f.BB(freq*1.e9,T_hood_MFT)*Hood_fil_L2_spill_MFT[j]+
                    f.BB(freq*1.e9,T_abs_MFT)*abs2_fil_L2_spill_MFT[j]*L2_eff+
                    f.BB(freq*1.e9,T_abs_MFT)*abs1_fil_L2_spill_MFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_apt_MFT)*apt_fil_L2_spill_MFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_fil_L2_spill_MFT[j]*hwp_eff*apt_eff*L1_eff*L2_eff
                    )*ref_fil_MFT
...
########################## FIL  ##############
            ############# Trans ##############
            p_fil_trans = f.BB(freq*1.e9,T_fil_MFT)*fil_emiss*det_eff_MFT[j]
           
            ########### 1st order  ###########

            p_fil_ref1 = f.BB(freq*1.e9,T_hood_MFT)*Hood_fil_spill_MFT[j]*ref_fil_MFT*det_eff_MFT[j]
...
########################## P_Opt  ##############
            ...
            eff = hwp_eff*apt_eff*L1_eff*L2_eff*fil_eff_MFT*det_eff_MFT[j]*pol_hwp_MFT[j]
...
##########################################################################
    ...
    for j in range(0,n2):
        ...
        for k in range(0,num):
            ...
            fil_emiss_HFT, fil_eff_HFT = f.Trm(t_fil_HFT, n_fil_HFT, tan_fil_HFT, freq*1.e9, ref_fil_HFT)

            p_cmb = f.BB(freq*1.e9,T_cmb)*hwp_eff*apt_eff*L1_eff*L2_eff*fil_eff_HFT*det_eff_HFT[j] # 

########################## HWP  ##############
            ############# Trans  #############
            p_hwp_trans = f.BB(freq*1.e9,T_hwp_HFT)*HWP_spill_HFT[j]*hwp_emiss_HFT[j]*apt_eff*L1_eff*L2_eff*fil_eff_HFT*det_eff_HFT[j]
           
            ########### 1st order  ###########
            p_hwp_ref1 = (f.BB(freq*1.e9,T_abs_HFT)*abs1_HWP_spill_HFT[j]*apt_eff+
                f.BB(freq*1.e9,T_abs_HFT)*abs2_HWP_spill_HFT[j]*L1_eff*apt_eff+
                f.BB(freq*1.e9,T_hood_HFT)*Hood_HWP_spill_HFT[j]*L2_eff*L1_eff*apt_eff
                )*ref_hwp_HFT[j]*apt_eff*L1_eff*L2_eff*fil_eff_HFT*det_eff_HFT[j]
           
            ########### 2cd order  ###########
            p_hwp_ref2 = (
                f.BB(freq*1.e9,T_L1_HFT)*L1_HWP_spill_HFT[j]*emiss_L1_HFT[j]+
                f.BB(freq*1.e9,T_L2_HFT)*L2_HWP_spill_HFT[j]*emiss_L2_HFT[j]*L1_eff+
                f.BB(freq*1.e9,T_fil_HFT)*fil_HWP_spill_HFT[j]*fil_emiss_HFT*L2_eff*L1_eff+
                (f.BB(freq*1.e9,T_abs_HFT)*abs1_L1_HWP_spill_HFT[j]+
                    f.BB(freq*1.e9,T_apt_HFT)*apt_L1_HWP_spill_HFT[j]+
                    f.BB(freq*1.e9,T_cmb)*CMB_L1_HWP_spill_HFT[j]*hwp_eff*apt_eff
                    )*ref_L1_HFT[j]+
                (f.BB(freq*1.e9,T_abs_HFT)*abs2_L2_HWP_spill_HFT[j]+
                    f.BB(freq*1.e9,T_abs_HFT)*abs1_L2_HWP_spill_HFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_apt_HFT)*apt_L2_HWP_spill_HFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_L2_HWP_spill_HFT[j]*hwp_eff*apt_eff*L1_eff
                    )*ref_L2_HFT[j]*L1_eff+
                (f.BB(freq*1.e9,T_hood_HFT)*Hood_fil_HWP_spill_HFT[j]+
                    f.BB(freq*1.e9,T_abs_HFT)*abs2_fil_HWP_spill_HFT[j]*L2_eff+
                    f.BB(freq*1.e9,T_abs_HFT)*abs1_fil_HWP_spill_HFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_apt_HFT)*apt_fil_HWP_spill_HFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_fil_HWP_spill_HFT[j]*hwp_eff*apt_eff*L1_eff*L2_eff
                    )*ref_fil_HFT*L2_eff*L1_eff
                )*ref_hwp_HFT[j]*apt_eff*L1_eff*L2_eff*fil_eff_HFT*det_eff_HFT[j]
...
########################## APT  ##############
            ############# Trans  #############
            p_apt = f.BB(freq*1.e9,T_apt_HFT)*apt_spill_HFT[j]*L1_eff*L2_eff*fil_eff_HFT*det_eff_HFT[j]

########################## L1   ##############
            ############# Trans  #############
            p_L1_trans = f.BB(freq*1.e9,T_L1_HFT)*L1_spill_HFT[j]*emiss_L1_HFT[j]*L2_eff*fil_eff_HFT*det_eff_HFT[j]
           
            ########### 1st order  ###########
            p_L1_ref1 = (f.BB(freq*1.e9,T_abs_HFT)*abs2_L1_spill_HFT[j]+
                f.BB(freq*1.e9,T_hood_HFT)*Hood_L1_spill_HFT[j]*L2_eff
                )*ref_L1_HFT[j]*L2_eff*fil_eff_HFT*det_eff_HFT[j]
           
            ########### 2cd order  ###########
            p_L1_ref2 = (
                f.BB(freq*1.e9,T_L2_HFT)*L2_L1_spill_HFT[j]*emiss_L2_HFT[j]+
                f.BB(freq*1.e9,T_fil_HFT)*fil_L1_spill_HFT[j]*fil_emiss_HFT*L2_eff+
                (f.BB(freq*1.e9,T_abs_HFT)*abs2_L2_L1_spill_HFT[j]+
                    f.BB(freq*1.e9,T_abs_HFT)*abs1_L2_L1_spill_HFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_apt_HFT)*apt_L2_L1_spill_HFT[j]*L1_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_L2_L1_spill_HFT[j]*hwp_eff*apt_eff*L1_eff
                    )*ref_L2_HFT[j]+
                (f.BB(freq*1.e9,T_hood_HFT)*Hood_fil_L1_spill_HFT[j]+
                    f.BB(freq*1.e9,T_abs_HFT)*abs2_fil_L1_spill_HFT[j]*L2_eff+
                    f.BB(freq*1.e9,T_abs_HFT)*abs1_fil_L1_spill_HFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_apt_HFT)*apt_fil_L1_spill_HFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_fil_L1_spill_HFT[j]*hwp_eff*apt_eff*L1_eff*L2_eff
                    )*ref_fil_HFT*L2_eff
                )*ref_L1_HFT[j]*L2_eff*fil_eff_HFT*det_eff_HFT[j]
...
########################## L2   ##############
            ############# Trans  #############
            p_L2_trans = f.BB(freq*1.e9,T_L2_HFT)*L2_spill_HFT[j]*emiss_L2_HFT[j]*fil_eff_HFT*det_eff_HFT[j]
           
            ########### 1st order  ###########
            p_L2_ref1 = (f.BB(freq*1.e9,T_hood_HFT)*Hood_L2_spill_HFT[j])*ref_L2_HFT[j]*fil_eff_HFT*det_eff_HFT[j]
           
            ########### 2cd order  ###########
            p_L2_ref2 = (
                f.BB(freq*1.e9,T_fil_HFT)*fil_L2_spill_HFT[j]*fil_emiss_HFT+
                (f.BB(freq*1.e9,T_hood_HFT)*Hood_fil_L2_spill_HFT[j]+
                    f.BB(freq*1.e9,T_abs_HFT)*abs2_fil_L2_spill_HFT[j]*L2_eff+
                    f.BB(freq*1.e9,T_abs_HFT)*abs1_fil_L2_spill_HFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_apt_HFT)*apt_fil_L2_spill_HFT[j]*L1_eff*L2_eff+
                    f.BB(freq*1.e9,T_cmb)*CMB_fil_L2_spill_HFT[j]*hwp_eff*apt_eff*L1_eff*L2_eff
                    )*ref_fil_HFT
...
########################## FIL  ##############
            ############# Trans ##############
            p_fil_trans = f.BB(freq*1.e9,T_fil_HFT)*fil_emiss*det_eff_HFT[j]
           
            ########### 1st order  ###########
            p_fil_ref1 = (f.BB(freq*1.e9,T_hood_HFT)*Hood_fil_spill_HFT[j])*ref_fil_HFT*det_eff_HFT[j]
...
########################## P_Opt  ##############
            ...
            eff = hwp_eff*apt_eff*L1_eff*L2_eff*fil_eff_HFT*det_eff_HFT[j]*pol_hwp_HFT[j]
