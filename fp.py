...
def LFT_FP(confLFT):
    if confLFT == 0:
        ...
        dpixLFT = np.array([[24., 24., 24.],[24., 24., 24.],[16., 16., 16.],[16., 16., 16.]])
        npixLFT = np.array([[32., 32., 32.],[32., 32., 32.],[72., 72., 72.],[72., 72., 72.]])
...
def HFT_FP(confHFT):
    ...
    if confHFT == 2: # F3.0 split optionA
       ...
       # freqHFT = np.array([[100., 140., 195.],[119., 166., 235.],[195., 235., 402.]])
        bandHFT = np.array([[0.23, 0.3, 0.3],[0.3, 0.3, 0.3],[0.3, 0.3, 0.23]])
        dpixHFT = np.array([[15.7, 15.7, 15.7],[15.7, 15.7, 15.7],[5.7, 5.7, 5.7]])
        npixHFT = np.array([[111.,111.,111.],[148.,148.,148.],[169.,169.,169.]]);
       # dpixHFT = np.array([[20.4, 20.4, 20.4],[20.4, 20.4, 20.4],[6.6, 15.3, 6.6]])
       # npixHFT = np.array([[57.,57.,57.],[76.,76.,76.],[127.,148.,127]]);
