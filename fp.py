...
def LFT_FP(confLFT):
    if confLFT == 0:
        freqLFT = np.array([[34., 60., 78.],[50., 68., 89.],[68., 89., 119.],[78., 100., 140.]])
...
def HFT_FP(confHFT):
    ...
    if confHFT == 2: # F3.0 split optionA
       ...
       # dpixHFT = np.array([[12., 12., 12,],[12., 12., 12.],[6.6, 6.6, 5.7]]) 
       # npixHFT = np.array([[183.,183.,183.],[244.,244.,244.],[127.,127.,169]]); 
