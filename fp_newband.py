...
def HFT_FP(confHFT):
    ...
    if confHFT == 2: # F3.0 split optionA
       ...
       # dpixHFT = np.array([[15.7, 15.7, 15.7,15.7, 15.7],[6.6, 6.6, 6.6, 6.6, 5.7]]) # dual band baseline
       # npixHFT = np.array([[111.,148.,111., 148.,111.],[127., 127.,127.,127.,169]]); # dual band baseline
